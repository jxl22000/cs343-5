    ...
    def elapseTime(self, gameState):
        ...
        # distribution over new positions for the ghost, given its previous position
            ...
            for pos, prob in newPosDist.items():
                updated[pos] += prob * self.beliefs[ghost]
        updated.normalize()
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        numJoint = len(jointPositions)
        for i in range(self.numParticles):
            self.particles.append(jointPositions[i % numJoint])
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                weight *= self.getObservationProb(noisyDistance, pacmanPosition, 
